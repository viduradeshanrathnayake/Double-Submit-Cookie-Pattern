...
if (!$_SESSION["logedIn"]) {
    ...
    echo ' <div class="container">  
                <div class="alert alert-success">
                    <b> Welcome! </b> <a href="signout.php">Sign out</a> 
                </div>
            </div>';
	}
	
//check form validations
	if (isset($_POST['double_sumbit_csrf_token']) && isset($_POST['phone_number']) && isset($_POST['card_number']) && isset($_POST['expire_date']) && isset($_POST['cvc']) && isset($_POST['amount'])) {
	...
	<div class="container">
		<div class="panel panel-info">
			<div class="panel-heading">
				<div class="panel-title">Mobile Reload</div>
			</div>
			<div style="padding-top:30px" class="panel-body">
				...
				<form id="changeForm" class="form-horizontal" role="form" method="post" action="double_submit_csrf_token.php">
					<div style="margin-bottom: 25px" class="form-group">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" name="phone_number" placeholder="07XXXXXXXX" required>
						</div>
					</div>
					<div style="margin-bottom: 25px" class="form-group">
						<label class="col-md-4 control-label" for="textinput">Credit/Debit Card Number</label>
						<div class="col-md-4">
							<input type="text" class="form-control" name="card_number" placeholder="88XXXXXXXXXXXXXX" required>
						</div>
					</div>
					<div style="margin-bottom: 25px" class="form-group">
						<label class="col-md-4 control-label" for="textinput">Expiry Date</label>
						<div class="col-md-4">
							<input type="text" class="form-control" name="expire_date" placeholder="MM/YYYY" required>
						</div>
					</div>
					<div style="margin-bottom: 25px" class="form-group">
					...
					<div style="margin-top:10px" class="form-group">
						...
						<div class="col-sm-4 controls">
							<button id="btn-bd" class="btn btn-lg btn-primary btn-block btn-signin" value="update" type="submit">Reload</button>
						</div>
					</div>
